...
export var fishAngle = new Array();
...
export var fishSpecies = new Array();
...
fishSpecies[4] = new Array(
	...
	1.0,
	0.995,
	'http://en.wikipedia.org/wiki/Bronze_corydoras',
	22
);
fishSpecies[5] = new Array(
	'Zebrafish',
	RARITY_POPULAR,
	48,
	25,
	...
	0.5,
	0.99,
	'http://en.wikipedia.org/wiki/Zebra_Danio',
	63
);
fishSpecies[6] = new Array(
	'Sailfin molly',
	RARITY_POPULAR,
	56,
	22,
...
fishSpecies[9] = new Array(
	...
	1.4,
	0.989,
	'http://en.wikipedia.org/wiki/Misgurnus_anguillicaudatus',
	15
);

fishSpecies[10] = new Array(
	'Paradise fish',
	RARITY_POPULAR,
	160,
	37,
...
fishSpecies[14] = new Array(
	...
	2.4,
	0.995,
	'http://en.wikipedia.org/wiki/Botia_macracantha',
	27
);
fishSpecies[15] = new Array(
	'Fairy cichlid',
	RARITY_POPULAR,
	448,
	32,
...
fishSpecies[16] = new Array(
	...
	1.7,
	0.991,
	'http://en.wikipedia.org/wiki/Pygocentrus_piraya',
	12
);
fishSpecies[17] = new Array(
...
fishSpecies[18] = new Array(
	...
	0.4,
	0.985,
	'http://en.wikipedia.org/wiki/Mikrogeophagus_ramirezi',
	45
);

fishSpecies[19] = new Array(
	'Oscar',
	RARITY_POPULAR,
	1280,
	89,
...
fishSpecies[21] = new Array(
	...
	1.2,
	0.992,
	'http://en.wikipedia.org/wiki/Sciaenochromis',
	26
);

fishSpecies[22] = new Array(
	'Goldfish',
	RARITY_POPULAR,
	2560,
	60,
...
fishSpecies[23] = new Array(
	...
	2.1,
	0.995,
	'http://en.wikipedia.org/wiki/Serrasalmus_rhombeus',
	1
);
fishSpecies[24] = new Array(
...
export function computeBreedingRate() {
	for (var i = 0; i < fishSpecies.length; i++) {
...
export var fishConstructor = function (sNum, fSize) {
	// Fish Position
	var x, y;
	this.getX = function () {
		return x;
	...
	this.hungerCheck = function () {
		...
		if (hunger > 0) {
			if (aquarium.getFood() > 0) {
				var eatFoodNumber = fishSpecies[specNum][SPEC_FOODNEED] * 10;
